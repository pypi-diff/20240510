# Comparing `tmp/skilleter_thingy-0.0.42.tar.gz` & `tmp/skilleter_thingy-0.0.43.tar.gz`
...
### Comparing `skilleter_thingy-0.0.42/skilleter_thingy/addpath.py` & `skilleter_thingy-0.0.43/skilleter_thingy/addpath.py`

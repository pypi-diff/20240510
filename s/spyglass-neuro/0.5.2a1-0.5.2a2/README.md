# Comparing `tmp/spyglass_neuro-0.5.2a1.tar.gz` & `tmp/spyglass_neuro-0.5.2a2.tar.gz`
...
### Comparing `spyglass_neuro-0.5.2a1/.pre-commit-config.yaml` & `spyglass_neuro-0.5.2a2/.pre-commit-config.yaml`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/CHANGELOG.md` & `spyglass_neuro-0.5.2a2/CHANGELOG.md`
...
### Comparing `spyglass_neuro-0.5.2a1/CITATION.cff` & `spyglass_neuro-0.5.2a2/CITATION.cff`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/CODE_OF_CONDUCT.md` & `spyglass_neuro-0.5.2a2/CODE_OF_CONDUCT.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/dj_local_conf_example.json` & `spyglass_neuro-0.5.2a2/dj_local_conf_example.json`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/environment.yml` & `spyglass_neuro-0.5.2a2/environment.yml`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/environment_dlc.yml` & `spyglass_neuro-0.5.2a2/environment_dlc.yml`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/.github/pull_request_template.md` & `spyglass_neuro-0.5.2a2/.github/pull_request_template.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/.github/ISSUE_TEMPLATE/bug_report.md` & `spyglass_neuro-0.5.2a2/.github/ISSUE_TEMPLATE/bug_report.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/.github/ISSUE_TEMPLATE/feature_request.md` & `spyglass_neuro-0.5.2a2/.github/ISSUE_TEMPLATE/feature_request.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/.github/workflows/publish-docs.yml` & `spyglass_neuro-0.5.2a2/.github/workflows/publish-docs.yml`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/.github/workflows/test-conda.yml` & `spyglass_neuro-0.5.2a2/.github/workflows/test-conda.yml`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/.github/workflows/test-package-build.yml` & `spyglass_neuro-0.5.2a2/.github/workflows/test-package-build.yml`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/.vscode/extensions.json` & `spyglass_neuro-0.5.2a2/.vscode/extensions.json`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/.vscode/settings.json` & `spyglass_neuro-0.5.2a2/.vscode/settings.json`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/config/dj_config.py` & `spyglass_neuro-0.5.2a2/config/dj_config.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/README.md` & `spyglass_neuro-0.5.2a2/docs/README.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/build-docs.sh` & `spyglass_neuro-0.5.2a2/docs/build-docs.sh`
...
### Comparing `spyglass_neuro-0.5.2a1/docs/mkdocs.yml` & `spyglass_neuro-0.5.2a2/docs/mkdocs.yml`
...
### Comparing `spyglass_neuro-0.5.2a1/docs/src/contribute.md` & `spyglass_neuro-0.5.2a2/docs/src/contribute.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/index.md` & `spyglass_neuro-0.5.2a2/docs/src/index.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/installation.md` & `spyglass_neuro-0.5.2a2/docs/src/installation.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/api/index.md` & `spyglass_neuro-0.5.2a2/docs/src/api/index.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/api/make_pages.py` & `spyglass_neuro-0.5.2a2/docs/src/api/make_pages.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/images/FrankLab.png` & `spyglass_neuro-0.5.2a2/docs/src/images/FrankLab.png`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/images/Spyglass.png` & `spyglass_neuro-0.5.2a2/docs/src/images/Spyglass.png`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/images/Spyglass.svg` & `spyglass_neuro-0.5.2a2/docs/src/images/Spyglass.svg`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/images/fig1.png` & `spyglass_neuro-0.5.2a2/docs/src/images/fig1.png`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/images/merge_diagram.png` & `spyglass_neuro-0.5.2a2/docs/src/images/merge_diagram.png`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/misc/database_management.md` & `spyglass_neuro-0.5.2a2/docs/src/misc/database_management.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/misc/export.md` & `spyglass_neuro-0.5.2a2/docs/src/misc/export.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/misc/figurl_views.md` & `spyglass_neuro-0.5.2a2/docs/src/misc/figurl_views.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/misc/insert_data.md` & `spyglass_neuro-0.5.2a2/docs/src/misc/insert_data.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/misc/merge_tables.md` & `spyglass_neuro-0.5.2a2/docs/src/misc/merge_tables.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/misc/mixin.md` & `spyglass_neuro-0.5.2a2/docs/src/misc/mixin.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/misc/session_groups.md` & `spyglass_neuro-0.5.2a2/docs/src/misc/session_groups.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/docs/src/stylesheets/extra.css` & `spyglass_neuro-0.5.2a2/docs/src/stylesheets/extra.css`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/examples/cli_examples/insert_sort_interval.py` & `spyglass_neuro-0.5.2a2/examples/cli_examples/insert_sort_interval.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/examples/cli_examples/readme.md` & `spyglass_neuro-0.5.2a2/examples/cli_examples/readme.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/examples/config_yaml/entries.yaml` & `spyglass_neuro-0.5.2a2/examples/config_yaml/entries.yaml`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/examples/config_yaml/sub-AppleBottom_ses-AppleBottom-DY20-g3_behavior+ecephys_spyglass_config.yaml` & `spyglass_neuro-0.5.2a2/examples/config_yaml/sub-AppleBottom_ses-AppleBottom-DY20-g3_behavior+ecephys_spyglass_config.yaml`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/franklab_scripts/alter_tables.py` & `spyglass_neuro-0.5.2a2/franklab_scripts/alter_tables.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/franklab_scripts/nightly_cleanup.py` & `spyglass_neuro-0.5.2a2/franklab_scripts/nightly_cleanup.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/franklab_scripts/sort.py` & `spyglass_neuro-0.5.2a2/franklab_scripts/sort.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/00_Setup.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/00_Setup.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/01_Insert_Data.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/01_Insert_Data.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/02_Data_Sync.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/02_Data_Sync.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/03_Merge_Tables.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/03_Merge_Tables.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/04_PopulateConfigFile.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/04_PopulateConfigFile.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/05_Export.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/05_Export.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/10_Spike_SortingV0.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/10_Spike_SortingV0.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/10_Spike_SortingV1.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/10_Spike_SortingV1.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/20_Position_Trodes.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/20_Position_Trodes.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/21_DLC.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/21_DLC.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/22_DLC_Loop.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/22_DLC_Loop.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/24_Linearization.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/24_Linearization.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/30_LFP.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/30_LFP.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/31_Theta.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/31_Theta.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/32_Ripple_Detection.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/32_Ripple_Detection.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/40_Extracting_Clusterless_Waveform_Features.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/40_Extracting_Clusterless_Waveform_Features.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/41_Decoding_Clusterless.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/41_Decoding_Clusterless.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/42_Decoding_SortedSpikes.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/42_Decoding_SortedSpikes.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/50_MUA_Detection.ipynb` & `spyglass_neuro-0.5.2a2/notebooks/50_MUA_Detection.ipynb`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/README.md` & `spyglass_neuro-0.5.2a2/notebooks/README.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/00_Setup.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/00_Setup.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/01_Insert_Data.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/01_Insert_Data.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/02_Data_Sync.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/02_Data_Sync.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/03_Merge_Tables.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/03_Merge_Tables.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/04_PopulateConfigFile.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/04_PopulateConfigFile.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/05_Export.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/05_Export.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/10_Spike_SortingV0.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/10_Spike_SortingV0.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/10_Spike_SortingV1.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/10_Spike_SortingV1.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/20_Position_Trodes.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/20_Position_Trodes.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/21_DLC.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/21_DLC.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/22_DLC_Loop.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/22_DLC_Loop.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/24_Linearization.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/24_Linearization.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/30_LFP.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/30_LFP.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/31_Theta.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/31_Theta.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/32_Ripple_Detection.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/32_Ripple_Detection.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/40_Extracting_Clusterless_Waveform_Features.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/40_Extracting_Clusterless_Waveform_Features.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/41_Decoding_Clusterless.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/41_Decoding_Clusterless.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/41_Extracting_Clusterless_Waveform_Features.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/41_Extracting_Clusterless_Waveform_Features.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/42_Decoding_Clusterless.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/42_Decoding_Clusterless.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/42_Decoding_SortedSpikes.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/42_Decoding_SortedSpikes.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/43_Decoding_SortedSpikes.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/43_Decoding_SortedSpikes.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/notebooks/py_scripts/51_MUA_Detection.py` & `spyglass_neuro-0.5.2a2/notebooks/py_scripts/51_MUA_Detection.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/settings.py` & `spyglass_neuro-0.5.2a2/src/spyglass/settings.py`
...
### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/cli/cli.py` & `spyglass_neuro-0.5.2a2/src/spyglass/cli/cli.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/__init__.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/__init__.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_behav.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_behav.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_device.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_device.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_dio.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_dio.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_ephys.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_ephys.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_filter.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_filter.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_interval.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_interval.py`
...
### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_lab.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_lab.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_nwbfile.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_nwbfile.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_position.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_position.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_region.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_region.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_ripple.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_ripple.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_sensors.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_sensors.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_session.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_session.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_subject.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_subject.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_task.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_task.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/common_usage.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/common_usage.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/populate_all_common.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/populate_all_common.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/signal_processing.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/signal_processing.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/common/prepopulate/prepopulate.py` & `spyglass_neuro-0.5.2a2/src/spyglass/common/prepopulate/prepopulate.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/data_import/insert_sessions.py` & `spyglass_neuro-0.5.2a2/src/spyglass/data_import/insert_sessions.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/__init__.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/__init__.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/decoding_merge.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/decoding_merge.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/v0/clusterless.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/v0/clusterless.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/v0/core.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/v0/core.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/v0/dj_decoder_conversion.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/v0/dj_decoder_conversion.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/v0/sorted_spikes.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/v0/sorted_spikes.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/v0/visualization.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/v0/visualization.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/v0/visualization_1D_view.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/v0/visualization_1D_view.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/v0/visualization_2D_view.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/v0/visualization_2D_view.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/v1/clusterless.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/v1/clusterless.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/v1/core.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/v1/core.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/v1/dj_decoder_conversion.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/v1/dj_decoder_conversion.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/v1/sorted_spikes.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/v1/sorted_spikes.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/decoding/v1/waveform_features.py` & `spyglass_neuro-0.5.2a2/src/spyglass/decoding/v1/waveform_features.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/lfp/lfp_electrode.py` & `spyglass_neuro-0.5.2a2/src/spyglass/lfp/lfp_electrode.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/lfp/lfp_imported.py` & `spyglass_neuro-0.5.2a2/src/spyglass/lfp/lfp_imported.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/lfp/lfp_merge.py` & `spyglass_neuro-0.5.2a2/src/spyglass/lfp/lfp_merge.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/lfp/analysis/v1/lfp_band.py` & `spyglass_neuro-0.5.2a2/src/spyglass/lfp/analysis/v1/lfp_band.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/lfp/v1/lfp.py` & `spyglass_neuro-0.5.2a2/src/spyglass/lfp/v1/lfp.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/lfp/v1/lfp_artifact.py` & `spyglass_neuro-0.5.2a2/src/spyglass/lfp/v1/lfp_artifact.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/lfp/v1/lfp_artifact_MAD_detection.py` & `spyglass_neuro-0.5.2a2/src/spyglass/lfp/v1/lfp_artifact_MAD_detection.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/lfp/v1/lfp_artifact_difference_detection.py` & `spyglass_neuro-0.5.2a2/src/spyglass/lfp/v1/lfp_artifact_difference_detection.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/linearization/merge.py` & `spyglass_neuro-0.5.2a2/src/spyglass/linearization/merge.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/linearization/v0/main.py` & `spyglass_neuro-0.5.2a2/src/spyglass/linearization/v0/main.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/linearization/v1/main.py` & `spyglass_neuro-0.5.2a2/src/spyglass/linearization/v1/main.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/lock/file_lock.py` & `spyglass_neuro-0.5.2a2/src/spyglass/lock/file_lock.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/mua/v1/mua.py` & `spyglass_neuro-0.5.2a2/src/spyglass/mua/v1/mua.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/position_merge.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/position_merge.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/__init__.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/__init__.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/dlc_decorators.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/dlc_decorators.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/dlc_reader.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/dlc_reader.py`
...
### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/dlc_utils.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/dlc_utils.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/position_dlc_centroid.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/position_dlc_centroid.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/position_dlc_cohort.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/position_dlc_cohort.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/position_dlc_model.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/position_dlc_model.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/position_dlc_orient.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/position_dlc_orient.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/position_dlc_pose_estimation.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/position_dlc_pose_estimation.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/position_dlc_position.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/position_dlc_position.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/position_dlc_project.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/position_dlc_project.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/position_dlc_selection.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/position_dlc_selection.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/position_dlc_training.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/position_dlc_training.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/position/v1/position_trodes_position.py` & `spyglass_neuro-0.5.2a2/src/spyglass/position/v1/position_trodes_position.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/ripple/v1/ripple.py` & `spyglass_neuro-0.5.2a2/src/spyglass/ripple/v1/ripple.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/sharing/sharing_kachery.py` & `spyglass_neuro-0.5.2a2/src/spyglass/sharing/sharing_kachery.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/imported.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/imported.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/spikesorting_merge.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/spikesorting_merge.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/analysis/v1/group.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/analysis/v1/group.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/__init__.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/__init__.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/curation_figurl.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/curation_figurl.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/merged_sorting_extractor.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/merged_sorting_extractor.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/sortingview.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/sortingview.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/sortingview_helper_fn.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/sortingview_helper_fn.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/spikesorting_artifact.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/spikesorting_artifact.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/spikesorting_curation.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/spikesorting_curation.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/spikesorting_populator.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/spikesorting_populator.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/spikesorting_recording.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/spikesorting_recording.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/spikesorting_sorting.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/spikesorting_sorting.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/figurl_views/SpikeSortingRecordingView.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/figurl_views/SpikeSortingRecordingView.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/figurl_views/SpikeSortingView.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/figurl_views/SpikeSortingView.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v0/figurl_views/prepare_spikesortingview_data.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v0/figurl_views/prepare_spikesortingview_data.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v1/__init__.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v1/__init__.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v1/artifact.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v1/artifact.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v1/curation.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v1/curation.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v1/figurl_curation.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v1/figurl_curation.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v1/metric_curation.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v1/metric_curation.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v1/metric_utils.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v1/metric_utils.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v1/recording.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v1/recording.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v1/sorting.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v1/sorting.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/spikesorting/v1/utils.py` & `spyglass_neuro-0.5.2a2/src/spyglass/spikesorting/v1/utils.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/utils/database_settings.py` & `spyglass_neuro-0.5.2a2/src/spyglass/utils/database_settings.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/utils/dj_chains.py` & `spyglass_neuro-0.5.2a2/src/spyglass/utils/dj_chains.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/utils/dj_graph.py` & `spyglass_neuro-0.5.2a2/src/spyglass/utils/dj_graph.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/utils/dj_helper_fn.py` & `spyglass_neuro-0.5.2a2/src/spyglass/utils/dj_helper_fn.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/utils/dj_merge_tables.py` & `spyglass_neuro-0.5.2a2/src/spyglass/utils/dj_merge_tables.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/utils/dj_mixin.py` & `spyglass_neuro-0.5.2a2/src/spyglass/utils/dj_mixin.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/utils/logging.py` & `spyglass_neuro-0.5.2a2/src/spyglass/utils/logging.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/src/spyglass/utils/nwb_helper_fn.py` & `spyglass_neuro-0.5.2a2/src/spyglass/utils/nwb_helper_fn.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/README.md` & `spyglass_neuro-0.5.2a2/tests/README.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/conftest.py` & `spyglass_neuro-0.5.2a2/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/container.py` & `spyglass_neuro-0.5.2a2/tests/container.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/conftest.py` & `spyglass_neuro-0.5.2a2/tests/common/conftest.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_behav.py` & `spyglass_neuro-0.5.2a2/tests/common/test_behav.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_device.py` & `spyglass_neuro-0.5.2a2/tests/common/test_device.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_dio.py` & `spyglass_neuro-0.5.2a2/tests/common/test_dio.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_ephys.py` & `spyglass_neuro-0.5.2a2/tests/common/test_ephys.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_filter.py` & `spyglass_neuro-0.5.2a2/tests/common/test_filter.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_insert.py` & `spyglass_neuro-0.5.2a2/tests/common/test_insert.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_interval.py` & `spyglass_neuro-0.5.2a2/tests/common/test_interval.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_interval_helpers.py` & `spyglass_neuro-0.5.2a2/tests/common/test_interval_helpers.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_lab.py` & `spyglass_neuro-0.5.2a2/tests/common/test_lab.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_nwbfile.py` & `spyglass_neuro-0.5.2a2/tests/common/test_nwbfile.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_position.py` & `spyglass_neuro-0.5.2a2/tests/common/test_position.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_region.py` & `spyglass_neuro-0.5.2a2/tests/common/test_region.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_sensors.py` & `spyglass_neuro-0.5.2a2/tests/common/test_sensors.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/common/test_session.py` & `spyglass_neuro-0.5.2a2/tests/common/test_session.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/data_import/test_insert_sessions.py` & `spyglass_neuro-0.5.2a2/tests/data_import/test_insert_sessions.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/lfp/conftest.py` & `spyglass_neuro-0.5.2a2/tests/lfp/conftest.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/lfp/test_lfp.py` & `spyglass_neuro-0.5.2a2/tests/lfp/test_lfp.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/linearization/conftest.py` & `spyglass_neuro-0.5.2a2/tests/linearization/conftest.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/position/test_trodes.py` & `spyglass_neuro-0.5.2a2/tests/position/test_trodes.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/utils/conftest.py` & `spyglass_neuro-0.5.2a2/tests/utils/conftest.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/utils/test_chains.py` & `spyglass_neuro-0.5.2a2/tests/utils/test_chains.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/utils/test_db_settings.py` & `spyglass_neuro-0.5.2a2/tests/utils/test_db_settings.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/utils/test_merge.py` & `spyglass_neuro-0.5.2a2/tests/utils/test_merge.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/tests/utils/test_mixin.py` & `spyglass_neuro-0.5.2a2/tests/utils/test_mixin.py`
...
### Comparing `spyglass_neuro-0.5.2a1/tests/utils/test_nwb_helper_fn.py` & `spyglass_neuro-0.5.2a2/tests/utils/test_nwb_helper_fn.py`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/.gitignore` & `spyglass_neuro-0.5.2a2/.gitignore`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/LICENSE` & `spyglass_neuro-0.5.2a2/LICENSE`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/README.md` & `spyglass_neuro-0.5.2a2/README.md`

 * *Files identical despite different names*

### Comparing `spyglass_neuro-0.5.2a1/pyproject.toml` & `spyglass_neuro-0.5.2a2/pyproject.toml`
...
### Comparing `spyglass_neuro-0.5.2a1/PKG-INFO` & `spyglass_neuro-0.5.2a2/PKG-INFO`

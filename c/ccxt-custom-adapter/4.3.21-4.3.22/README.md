# Comparing `tmp/ccxt-custom-adapter-4.3.21.tar.gz` & `tmp/ccxt-custom-adapter-4.3.22.tar.gz`
...
### Comparing `ccxt-custom-adapter-4.3.21/LICENSE.txt` & `ccxt-custom-adapter-4.3.22/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/PKG-INFO` & `ccxt-custom-adapter-4.3.22/PKG-INFO`
...
### Comparing `ccxt-custom-adapter-4.3.21/README.rst` & `ccxt-custom-adapter-4.3.22/README.rst`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/__init__.py` & `ccxt-custom-adapter-4.3.22/ccxt/__init__.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/ace.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/ace.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/alpaca.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/alpaca.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/ascendex.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/ascendex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bequant.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bequant.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bigone.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bigone.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/binance.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/binance.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/binancecoinm.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/binancecoinm.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/binanceus.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/binanceus.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/binanceusdm.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/binanceusdm.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bingx.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bingx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bit2c.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bit2c.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitbank.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitbank.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitbay.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitbay.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitbns.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitbns.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitcoincom.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitcoincom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitfinex.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitfinex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitfinex2.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitfinex2.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitflyer.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitflyer.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitget.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitget.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bithumb.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bithumb.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitmart.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitmart.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitmex.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitmex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitopro.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitopro.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitpanda.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitpanda.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitrue.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitrue.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitso.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitso.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitstamp.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitstamp.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitteam.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitteam.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bitvavo.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bitvavo.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bl3p.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bl3p.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/blockchaincom.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/blockchaincom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/blofin.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/blofin.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/btcalpha.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/btcalpha.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/btcbox.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/btcbox.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/btcmarkets.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/btcmarkets.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/btcturk.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/btcturk.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/bybit.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/bybit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/cex.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/cex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/coinbase.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/coinbase.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/coinbaseinternational.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/coinbaseinternational.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/coinbasepro.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/coinbasepro.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/coincheck.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/coincheck.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/coinex.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/coinex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/coinlist.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/coinlist.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/coinmate.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/coinmate.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/coinmetro.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/coinmetro.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/coinone.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/coinone.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/coinsph.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/coinsph.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/coinspot.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/coinspot.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/cryptocom.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/cryptocom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/currencycom.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/currencycom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/delta.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/delta.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/deribit.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/deribit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/digifinex.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/digifinex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/exmo.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/exmo.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/fmfwio.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/fmfwio.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/gate.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/gate.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/gateio.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/gateio.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/gemini.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/gemini.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/hitbtc.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/hitbtc.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/hitbtc3.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/hitbtc3.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/hollaex.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/hollaex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/htx.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/htx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/huobi.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/huobi.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/huobijp.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/huobijp.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/idax.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/idax.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/idex.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/idex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/independentreserve.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/independentreserve.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/indodax.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/indodax.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/kraken.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/kraken.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/krakenfutures.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/krakenfutures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/kucoin.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/kucoin.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/kucoinfutures.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/kucoinfutures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/kuna.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/kuna.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/latoken.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/latoken.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/lbank.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/lbank.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/luno.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/luno.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/lykke.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/lykke.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/mercado.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/mercado.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/mexc.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/mexc.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/ndax.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/ndax.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/novadax.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/novadax.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/oceanex.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/oceanex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/okcoin.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/okcoin.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/okx.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/okx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/onetrading.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/onetrading.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/p2b.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/p2b.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/paymium.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/paymium.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/phemex.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/phemex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/poloniex.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/poloniex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/poloniexfutures.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/poloniexfutures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/probit.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/probit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/timex.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/timex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/tokocrypto.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/tokocrypto.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/tradeogre.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/tradeogre.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/upbit.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/upbit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/wavesexchange.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/wavesexchange.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/wazirx.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/wazirx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/whitebit.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/whitebit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/woo.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/woo.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/yobit.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/yobit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/zaif.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/zaif.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/abstract/zonda.py` & `ccxt-custom-adapter-4.3.22/ccxt/abstract/zonda.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/ace.py` & `ccxt-custom-adapter-4.3.22/ccxt/ace.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/alpaca.py` & `ccxt-custom-adapter-4.3.22/ccxt/alpaca.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/ascendex.py` & `ccxt-custom-adapter-4.3.22/ccxt/ascendex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/__init__.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/__init__.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/ace.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/ace.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/alpaca.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/alpaca.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/ascendex.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/ascendex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/base/exchange.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/base/exchange.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/base/throttler.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/base/throttler.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/base/ws/__init__.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/base/ws/__init__.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/base/ws/aiohttp_client.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/base/ws/aiohttp_client.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/base/ws/cache.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/base/ws/cache.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/base/ws/client.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/base/ws/client.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/base/ws/fast_client.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/base/ws/fast_client.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/base/ws/functions.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/base/ws/functions.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/base/ws/future.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/base/ws/future.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/base/ws/order_book.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/base/ws/order_book.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/base/ws/order_book_side.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/base/ws/order_book_side.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bequant.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bequant.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bigone.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bigone.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/binance.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/binance.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/binancecoinm.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/binancecoinm.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/binanceus.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/binanceus.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/binanceusdm.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/binanceusdm.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bingx.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bingx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bit2c.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bit2c.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitbank.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitbank.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitbns.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitbns.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitcoincom.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitcoincom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitfinex.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitfinex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitfinex2.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitfinex2.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitflyer.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitflyer.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitget.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitget.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bithumb.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bithumb.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitmart.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitmart.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitmex.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitmex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitopro.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitopro.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitrue.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitrue.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitso.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitso.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitstamp.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitstamp.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitteam.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitteam.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bitvavo.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bitvavo.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bl3p.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bl3p.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/blockchaincom.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/blockchaincom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/blofin.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/blofin.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/btcalpha.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/btcalpha.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/btcbox.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/btcbox.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/btcmarkets.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/btcmarkets.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/btcturk.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/btcturk.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/bybit.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/bybit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/cex.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/cex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/coinbase.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/coinbase.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/coinbaseinternational.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/coinbaseinternational.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/coinbasepro.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/coinbasepro.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/coincheck.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/coincheck.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/coinex.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/coinex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/coinlist.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/coinlist.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/coinmate.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/coinmate.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/coinmetro.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/coinmetro.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/coinone.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/coinone.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/coinsph.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/coinsph.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/coinspot.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/coinspot.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/cryptocom.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/cryptocom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/currencycom.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/currencycom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/delta.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/delta.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/deribit.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/deribit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/digifinex.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/digifinex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/exmo.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/exmo.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/fmfwio.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/fmfwio.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/gate.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/gate.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/gemini.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/gemini.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/hitbtc.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/hitbtc.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/hollaex.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/hollaex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/htx.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/htx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/huobijp.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/huobijp.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/hyperliquid.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/hyperliquid.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/idax.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/idax.py`
...
### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/idex.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/idex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/independentreserve.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/independentreserve.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/indodax.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/indodax.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/kraken.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/kraken.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/krakenfutures.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/krakenfutures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/kucoin.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/kucoin.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/kucoinfutures.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/kucoinfutures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/kuna.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/kuna.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/latoken.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/latoken.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/lbank.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/lbank.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/luno.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/luno.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/lykke.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/lykke.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/mercado.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/mercado.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/mexc.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/mexc.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/ndax.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/ndax.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/novadax.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/novadax.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/oceanex.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/oceanex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/okcoin.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/okcoin.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/okx.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/okx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/onetrading.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/onetrading.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/p2b.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/p2b.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/paymium.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/paymium.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/phemex.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/phemex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/poloniex.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/poloniex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/poloniexfutures.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/poloniexfutures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/probit.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/probit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/timex.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/timex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/tokocrypto.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/tokocrypto.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/tradeogre.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/tradeogre.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/upbit.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/upbit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/wavesexchange.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/wavesexchange.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/wazirx.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/wazirx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/whitebit.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/whitebit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/woo.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/woo.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/yobit.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/yobit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/zaif.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/zaif.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/async_support/zonda.py` & `ccxt-custom-adapter-4.3.22/ccxt/async_support/zonda.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/base/__init__.py` & `ccxt-custom-adapter-4.3.22/ccxt/base/__init__.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/base/decimal_to_precision.py` & `ccxt-custom-adapter-4.3.22/ccxt/base/decimal_to_precision.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/base/errors.py` & `ccxt-custom-adapter-4.3.22/ccxt/base/errors.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/base/exchange.py` & `ccxt-custom-adapter-4.3.22/ccxt/base/exchange.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/base/precise.py` & `ccxt-custom-adapter-4.3.22/ccxt/base/precise.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/base/types.py` & `ccxt-custom-adapter-4.3.22/ccxt/base/types.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bequant.py` & `ccxt-custom-adapter-4.3.22/ccxt/bequant.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bigone.py` & `ccxt-custom-adapter-4.3.22/ccxt/bigone.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/binance.py` & `ccxt-custom-adapter-4.3.22/ccxt/binance.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/binancecoinm.py` & `ccxt-custom-adapter-4.3.22/ccxt/binancecoinm.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/binanceus.py` & `ccxt-custom-adapter-4.3.22/ccxt/binanceus.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/binanceusdm.py` & `ccxt-custom-adapter-4.3.22/ccxt/binanceusdm.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bingx.py` & `ccxt-custom-adapter-4.3.22/ccxt/bingx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bit2c.py` & `ccxt-custom-adapter-4.3.22/ccxt/bit2c.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitbank.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitbank.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitbns.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitbns.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitfinex.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitfinex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitfinex2.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitfinex2.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitflyer.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitflyer.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitget.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitget.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bithumb.py` & `ccxt-custom-adapter-4.3.22/ccxt/bithumb.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitmart.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitmart.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitmex.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitmex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitopro.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitopro.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitrue.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitrue.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitso.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitso.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitstamp.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitstamp.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitteam.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitteam.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bitvavo.py` & `ccxt-custom-adapter-4.3.22/ccxt/bitvavo.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bl3p.py` & `ccxt-custom-adapter-4.3.22/ccxt/bl3p.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/blockchaincom.py` & `ccxt-custom-adapter-4.3.22/ccxt/blockchaincom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/blofin.py` & `ccxt-custom-adapter-4.3.22/ccxt/blofin.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/btcalpha.py` & `ccxt-custom-adapter-4.3.22/ccxt/btcalpha.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/btcbox.py` & `ccxt-custom-adapter-4.3.22/ccxt/btcbox.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/btcmarkets.py` & `ccxt-custom-adapter-4.3.22/ccxt/btcmarkets.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/btcturk.py` & `ccxt-custom-adapter-4.3.22/ccxt/btcturk.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/bybit.py` & `ccxt-custom-adapter-4.3.22/ccxt/bybit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/cex.py` & `ccxt-custom-adapter-4.3.22/ccxt/cex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/coinbase.py` & `ccxt-custom-adapter-4.3.22/ccxt/coinbase.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/coinbaseinternational.py` & `ccxt-custom-adapter-4.3.22/ccxt/coinbaseinternational.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/coinbasepro.py` & `ccxt-custom-adapter-4.3.22/ccxt/coinbasepro.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/coincheck.py` & `ccxt-custom-adapter-4.3.22/ccxt/coincheck.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/coinex.py` & `ccxt-custom-adapter-4.3.22/ccxt/coinex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/coinlist.py` & `ccxt-custom-adapter-4.3.22/ccxt/coinlist.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/coinmate.py` & `ccxt-custom-adapter-4.3.22/ccxt/coinmate.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/coinmetro.py` & `ccxt-custom-adapter-4.3.22/ccxt/coinmetro.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/coinone.py` & `ccxt-custom-adapter-4.3.22/ccxt/coinone.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/coinsph.py` & `ccxt-custom-adapter-4.3.22/ccxt/coinsph.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/coinspot.py` & `ccxt-custom-adapter-4.3.22/ccxt/coinspot.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/cryptocom.py` & `ccxt-custom-adapter-4.3.22/ccxt/cryptocom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/currencycom.py` & `ccxt-custom-adapter-4.3.22/ccxt/currencycom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/delta.py` & `ccxt-custom-adapter-4.3.22/ccxt/delta.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/deribit.py` & `ccxt-custom-adapter-4.3.22/ccxt/deribit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/digifinex.py` & `ccxt-custom-adapter-4.3.22/ccxt/digifinex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/exmo.py` & `ccxt-custom-adapter-4.3.22/ccxt/exmo.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/fmfwio.py` & `ccxt-custom-adapter-4.3.22/ccxt/fmfwio.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/gate.py` & `ccxt-custom-adapter-4.3.22/ccxt/gate.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/gemini.py` & `ccxt-custom-adapter-4.3.22/ccxt/gemini.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/hitbtc.py` & `ccxt-custom-adapter-4.3.22/ccxt/hitbtc.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/hollaex.py` & `ccxt-custom-adapter-4.3.22/ccxt/hollaex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/htx.py` & `ccxt-custom-adapter-4.3.22/ccxt/htx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/huobijp.py` & `ccxt-custom-adapter-4.3.22/ccxt/huobijp.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/hyperliquid.py` & `ccxt-custom-adapter-4.3.22/ccxt/hyperliquid.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/idax.py` & `ccxt-custom-adapter-4.3.22/ccxt/idax.py`
...
### Comparing `ccxt-custom-adapter-4.3.21/ccxt/idex.py` & `ccxt-custom-adapter-4.3.22/ccxt/idex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/independentreserve.py` & `ccxt-custom-adapter-4.3.22/ccxt/independentreserve.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/indodax.py` & `ccxt-custom-adapter-4.3.22/ccxt/indodax.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/kraken.py` & `ccxt-custom-adapter-4.3.22/ccxt/kraken.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/krakenfutures.py` & `ccxt-custom-adapter-4.3.22/ccxt/krakenfutures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/kucoin.py` & `ccxt-custom-adapter-4.3.22/ccxt/kucoin.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/kucoinfutures.py` & `ccxt-custom-adapter-4.3.22/ccxt/kucoinfutures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/kuna.py` & `ccxt-custom-adapter-4.3.22/ccxt/kuna.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/latoken.py` & `ccxt-custom-adapter-4.3.22/ccxt/latoken.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/lbank.py` & `ccxt-custom-adapter-4.3.22/ccxt/lbank.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/luno.py` & `ccxt-custom-adapter-4.3.22/ccxt/luno.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/lykke.py` & `ccxt-custom-adapter-4.3.22/ccxt/lykke.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/mercado.py` & `ccxt-custom-adapter-4.3.22/ccxt/mercado.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/mexc.py` & `ccxt-custom-adapter-4.3.22/ccxt/mexc.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/ndax.py` & `ccxt-custom-adapter-4.3.22/ccxt/ndax.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/novadax.py` & `ccxt-custom-adapter-4.3.22/ccxt/novadax.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/oceanex.py` & `ccxt-custom-adapter-4.3.22/ccxt/oceanex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/okcoin.py` & `ccxt-custom-adapter-4.3.22/ccxt/okcoin.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/okx.py` & `ccxt-custom-adapter-4.3.22/ccxt/okx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/onetrading.py` & `ccxt-custom-adapter-4.3.22/ccxt/onetrading.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/p2b.py` & `ccxt-custom-adapter-4.3.22/ccxt/p2b.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/paymium.py` & `ccxt-custom-adapter-4.3.22/ccxt/paymium.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/phemex.py` & `ccxt-custom-adapter-4.3.22/ccxt/phemex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/poloniex.py` & `ccxt-custom-adapter-4.3.22/ccxt/poloniex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/poloniexfutures.py` & `ccxt-custom-adapter-4.3.22/ccxt/poloniexfutures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/__init__.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/__init__.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/alpaca.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/alpaca.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/ascendex.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/ascendex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bequant.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bequant.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/binance.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/binance.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/binancecoinm.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/binancecoinm.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/binanceus.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/binanceus.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/binanceusdm.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/binanceusdm.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bingx.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bingx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bitcoincom.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bitcoincom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bitfinex.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bitfinex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bitfinex2.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bitfinex2.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bitget.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bitget.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bithumb.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bithumb.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bitmart.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bitmart.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bitmex.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bitmex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bitopro.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bitopro.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bitrue.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bitrue.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bitstamp.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bitstamp.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bitvavo.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bitvavo.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/blockchaincom.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/blockchaincom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/bybit.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/bybit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/cex.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/cex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/coinbase.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/coinbase.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/coinbaseinternational.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/coinbaseinternational.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/coinbasepro.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/coinbasepro.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/coincheck.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/coincheck.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/coinex.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/coinex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/coinone.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/coinone.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/cryptocom.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/cryptocom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/currencycom.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/currencycom.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/deribit.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/deribit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/exmo.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/exmo.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/gate.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/gate.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/gemini.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/gemini.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/hitbtc.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/hitbtc.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/hollaex.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/hollaex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/htx.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/htx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/huobijp.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/huobijp.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/hyperliquid.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/hyperliquid.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/idex.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/idex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/independentreserve.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/independentreserve.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/kraken.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/kraken.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/krakenfutures.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/krakenfutures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/kucoin.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/kucoin.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/kucoinfutures.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/kucoinfutures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/lbank.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/lbank.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/luno.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/luno.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/mexc.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/mexc.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/ndax.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/ndax.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/okcoin.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/okcoin.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/okx.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/okx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/onetrading.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/onetrading.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/p2b.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/p2b.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/phemex.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/phemex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/poloniex.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/poloniex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/poloniexfutures.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/poloniexfutures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/probit.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/probit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/upbit.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/upbit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/wazirx.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/wazirx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/whitebit.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/whitebit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/pro/woo.py` & `ccxt-custom-adapter-4.3.22/ccxt/pro/woo.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/probit.py` & `ccxt-custom-adapter-4.3.22/ccxt/probit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ecdsa/__init__.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ecdsa/__init__.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ecdsa/_version.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ecdsa/_version.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ecdsa/curves.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ecdsa/curves.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ecdsa/der.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ecdsa/der.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ecdsa/ecdsa.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ecdsa/ecdsa.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ecdsa/ellipticcurve.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ecdsa/ellipticcurve.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ecdsa/keys.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ecdsa/keys.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ecdsa/numbertheory.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ecdsa/numbertheory.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ecdsa/rfc6979.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ecdsa/rfc6979.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ecdsa/util.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ecdsa/util.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/abi/base.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/abi/base.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/abi/codec.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/abi/codec.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/abi/decoding.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/abi/decoding.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/abi/encoding.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/abi/encoding.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/abi/exceptions.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/abi/exceptions.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/abi/grammar.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/abi/grammar.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/abi/registry.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/abi/registry.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/abi/tools/_strategies.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/abi/tools/_strategies.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/abi/utils/numeric.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/abi/utils/numeric.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/account/encode_typed_data/encoding_and_hashing.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/account/encode_typed_data/encoding_and_hashing.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/account/encode_typed_data/helpers.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/account/encode_typed_data/helpers.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/account/messages.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/account/messages.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/hexbytes/_utils.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/hexbytes/_utils.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/hexbytes/main.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/hexbytes/main.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/typing/__init__.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/typing/__init__.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/typing/evm.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/typing/evm.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/typing/networks.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/typing/networks.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/__init__.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/abi.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/abi.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/address.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/address.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/applicators.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/applicators.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/conversions.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/conversions.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/currency.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/currency.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/curried/__init__.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/curried/__init__.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/decorators.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/decorators.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/functional.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/functional.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/hexadecimal.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/hexadecimal.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/humanize.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/humanize.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/logging.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/logging.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/module_loading.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/module_loading.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/numeric.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/numeric.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/toolz.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/toolz.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/types.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/types.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/ethereum/utils/units.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/ethereum/utils/units.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/keccak/keccak.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/keccak/keccak.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/msgpack/__init__.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/msgpack/__init__.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/msgpack/exceptions.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/msgpack/exceptions.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/msgpack/ext.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/msgpack/ext.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/msgpack/fallback.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/msgpack/fallback.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/parsimonious/exceptions.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/parsimonious/exceptions.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/parsimonious/expressions.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/parsimonious/expressions.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/parsimonious/grammar.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/parsimonious/grammar.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/parsimonious/nodes.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/parsimonious/nodes.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/parsimonious/utils.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/parsimonious/utils.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/toolz/_signatures.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/toolz/_signatures.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/toolz/_version.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/toolz/_version.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/toolz/compatibility.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/toolz/compatibility.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/toolz/curried/__init__.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/toolz/curried/__init__.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/toolz/curried/operator.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/toolz/curried/operator.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/toolz/dicttoolz.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/toolz/dicttoolz.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/toolz/functoolz.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/toolz/functoolz.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/toolz/itertoolz.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/toolz/itertoolz.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/static_dependencies/toolz/recipes.py` & `ccxt-custom-adapter-4.3.22/ccxt/static_dependencies/toolz/recipes.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/__init__.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/__init__.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_account.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_account.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_balance.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_balance.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_borrow_interest.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_borrow_interest.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_borrow_rate.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_borrow_rate.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_calculate_fee.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_calculate_fee.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_crypto.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_crypto.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_currency.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_currency.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_datetime.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_datetime.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_decimal_to_precision.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_decimal_to_precision.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_deep_extend.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_deep_extend.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_deposit_withdrawal.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_deposit_withdrawal.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_exchange_datetime_functions.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_exchange_datetime_functions.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_funding_rate_history.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_funding_rate_history.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_last_price.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_last_price.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_ledger_entry.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_ledger_entry.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_ledger_item.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_ledger_item.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_leverage_tier.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_leverage_tier.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_margin_mode.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_margin_mode.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_margin_modification.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_margin_modification.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_market.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_market.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_number.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_number.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_ohlcv.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_ohlcv.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_open_interest.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_open_interest.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_order.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_order.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_order_book.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_order_book.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_position.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_position.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_shared_methods.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_shared_methods.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_status.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_status.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_throttle.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_throttle.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_ticker.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_ticker.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_trade.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_trade.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_trading_fee.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_trading_fee.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/base/test_transaction.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/base/test_transaction.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/test_async.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/test_async.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/test/test_sync.py` & `ccxt-custom-adapter-4.3.22/ccxt/test/test_sync.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/timex.py` & `ccxt-custom-adapter-4.3.22/ccxt/timex.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/tokocrypto.py` & `ccxt-custom-adapter-4.3.22/ccxt/tokocrypto.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/tradeogre.py` & `ccxt-custom-adapter-4.3.22/ccxt/tradeogre.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/upbit.py` & `ccxt-custom-adapter-4.3.22/ccxt/upbit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/wavesexchange.py` & `ccxt-custom-adapter-4.3.22/ccxt/wavesexchange.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/wazirx.py` & `ccxt-custom-adapter-4.3.22/ccxt/wazirx.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/whitebit.py` & `ccxt-custom-adapter-4.3.22/ccxt/whitebit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/woo.py` & `ccxt-custom-adapter-4.3.22/ccxt/woo.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/yobit.py` & `ccxt-custom-adapter-4.3.22/ccxt/yobit.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/zaif.py` & `ccxt-custom-adapter-4.3.22/ccxt/zaif.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt/zonda.py` & `ccxt-custom-adapter-4.3.22/ccxt/zonda.py`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/ccxt_custom_adapter.egg-info/PKG-INFO` & `ccxt-custom-adapter-4.3.22/ccxt_custom_adapter.egg-info/PKG-INFO`
...
### Comparing `ccxt-custom-adapter-4.3.21/ccxt_custom_adapter.egg-info/SOURCES.txt` & `ccxt-custom-adapter-4.3.22/ccxt_custom_adapter.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `ccxt-custom-adapter-4.3.21/package.json` & `ccxt-custom-adapter-4.3.22/package.json`
...
### Comparing `ccxt-custom-adapter-4.3.21/setup.py` & `ccxt-custom-adapter-4.3.22/setup.py`

# Comparing `tmp/create_dara_app-1.8.6-py3-none-any.whl.zip` & `tmp/create_dara_app-1.9.0-py3-none-any.whl.zip`
...
## Comparing `create_dara_app-1.8.6.dist-info/LICENSE` & `create_dara_app-1.9.0.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `create_dara_app-1.8.6.dist-info/METADATA` & `create_dara_app-1.9.0.dist-info/METADATA`
...
## Comparing `create_dara_app-1.8.6.dist-info/RECORD` & `create_dara_app-1.9.0.dist-info/RECORD`

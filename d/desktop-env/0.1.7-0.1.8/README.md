# Comparing `tmp/desktop_env-0.1.7.tar.gz` & `tmp/desktop_env-0.1.8.tar.gz`
...
### Comparing `desktop_env-0.1.7/desktop_env/evaluators/getters/chrome.py` & `desktop_env-0.1.8/desktop_env/evaluators/getters/chrome.py`
